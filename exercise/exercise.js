...
//Start coding here
var mondayGoals = ['Water Wise Workshop' , 'Physics' , 'IT PAT'];
var tuesdayGoals = ["Math" , "English", "LO Presentation"];
var wednesdayGoals = ["English" , "Life Sciences" , "Netball Practice"];
var thursdayGoals = ["IT" , "Math" , "Play"];
var fridayGoals = ["Afrikaans" , "Life Sciences" , "Read"];
var saturdayGoals = ["Code4CT" , "Oracle" , "Study"];
var sundayGoals = ["church" , "eat" , "study"];
...
//This if statements checks if all of the checkboxes are checked
    if(checkbox1.checked === true && checkbox2.checked === true && checkbox3.checked === true){
      ...
      if(selectedDay === 'tuesday'){
      tuesday.setAttribute('style', 'background-color: red; color: white; border: 0px solid transparent;');
      }
      if(selectedDay === 'wednesday'){
      wednesday.setAttribute('style', 'background-color: red; color: white; border: 0px solid transparent;');
      }
      if(selectedDay === 'thursday'){
      thursday.setAttribute('style', 'background-color: red; color: white; border: 0px solid transparent;');
      }
      if(selectedDay === 'friday'){
      friday.setAttribute('style', 'background-color: red; color: white; border: 0px solid transparent;');
      }
      if(selectedDay === 'saturday'){
      saturday.setAttribute('style', 'background-color: red; color: white; border: 0px solid transparent;');
      }
      if(selectedDay === 'sunday'){
      sunday.setAttribute('style', 'background-color: red; color: white; border: 0px solid transparent;');
      }
